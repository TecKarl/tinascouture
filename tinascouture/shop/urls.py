...
urlpatterns = [
    ...
    path("manage/profile/", views.admin_profile_view, name="admin_profile"),
    path("manage/profile/password/", views.admin_password_change_view, name="admin_password_change"),
